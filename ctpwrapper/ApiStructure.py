...
class RspUserLoginField(Base):
    ...
    def __init__(self,TradingDay='',LoginTime='',BrokerID='',UserID='',SystemName='',FrontID='',SessionID='',MaxOrderRef='',SHFETime='',DCETime='',CZCETime='',FFEXTime='',INETime=''):
...
class TransferHeaderField(Base):
    ...
    def __init__(self,Version='',TradeCode='',TradeDate='',TradeTime='',TradeSerial='',FutureID='',BankID='',BankBrchID='',OperNo='',DeviceID='',RecordNum='',SessionID='',RequestID=''):
...
class TransferQryDetailRspField(Base):
    ...
    def __init__(self,TradeDate='',TradeTime='',TradeCode='',FutureSerial='',FutureID='',FutureAccount='',BankSerial='',BankID='',BankBrchID='',BankAccount='',CertCode='',CurrencyCode='',TxAmount='',Flag=''):
...
class ProductField(Base):
    ...
    def __init__(self,ProductID='',ProductName='',ExchangeID='',ProductClass='',VolumeMultiple='',PriceTick='',MaxMarketOrderVolume='',MinMarketOrderVolume='',MaxLimitOrderVolume='',MinLimitOrderVolume='',PositionType='',PositionDateType='',CloseDealType='',TradeCurrencyID='',MortgageFundUseRange='',ExchangeProductID='',UnderlyingMultiple=''):
...
class InvestorField(Base):
    ...
    def __init__(self,InvestorID='',BrokerID='',InvestorGroupID='',InvestorName='',IdentifiedCardType='',IdentifiedCardNo='',IsActive='',Telephone='',Address='',OpenDate='',Mobile='',CommModelID='',MarginModelID=''):
...
class InstrumentMarginRateField(Base):
    ...
    def __init__(self,InstrumentID='',InvestorRange='',BrokerID='',InvestorID='',HedgeFlag='',LongMarginRatioByMoney='',LongMarginRatioByVolume='',ShortMarginRatioByMoney='',ShortMarginRatioByVolume='',IsRelative=''):
...
class InstrumentCommissionRateField(Base):
    ...
    def __init__(self,InstrumentID='',InvestorRange='',BrokerID='',InvestorID='',OpenRatioByMoney='',OpenRatioByVolume='',CloseRatioByMoney='',CloseRatioByVolume='',CloseTodayRatioByMoney='',CloseTodayRatioByVolume=''):
...
class DepthMarketDataField(Base):
    ...
    def __init__(self,TradingDay='',InstrumentID='',ExchangeID='',ExchangeInstID='',LastPrice='',PreSettlementPrice='',PreClosePrice='',PreOpenInterest='',OpenPrice='',HighestPrice='',LowestPrice='',Volume='',Turnover='',OpenInterest='',ClosePrice='',SettlementPrice='',UpperLimitPrice='',LowerLimitPrice='',PreDelta='',CurrDelta='',UpdateTime='',UpdateMillisec='',BidPrice1='',BidVolume1='',AskPrice1='',AskVolume1='',BidPrice2='',BidVolume2='',AskPrice2='',AskVolume2='',BidPrice3='',BidVolume3='',AskPrice3='',AskVolume3='',BidPrice4='',BidVolume4='',AskPrice4='',AskVolume4='',BidPrice5='',BidVolume5='',AskPrice5='',AskVolume5='',AveragePrice='',ActionDay=''):
...
class TraderOfferField(Base):
    ...
    def __init__(self,ExchangeID='',TraderID='',ParticipantID='',Password='',InstallID='',OrderLocalID='',TraderConnectStatus='',ConnectRequestDate='',ConnectRequestTime='',LastReportDate='',LastReportTime='',ConnectDate='',ConnectTime='',StartDate='',StartTime='',TradingDay='',BrokerID='',MaxTradeID='',MaxOrderMessageReference=''):
...
class ExchangeMarginRateField(Base):
    ...
    def __init__(self,BrokerID='',InstrumentID='',HedgeFlag='',LongMarginRatioByMoney='',LongMarginRatioByVolume='',ShortMarginRatioByMoney='',ShortMarginRatioByVolume=''):
...
class LoginInfoField(Base):
    ...
    def __init__(self,FrontID='',SessionID='',BrokerID='',UserID='',LoginDate='',LoginTime='',IPAddress='',UserProductInfo='',InterfaceProductInfo='',ProtocolInfo='',SystemName='',Password='',MaxOrderRef='',SHFETime='',DCETime='',CZCETime='',FFEXTime='',MacAddress='',OneTimePassword='',INETime='',IsQryControl='',LoginRemark=''):
...
class ExchangeOrderField(Base):
    ...
    def __init__(self,OrderPriceType='',Direction='',CombOffsetFlag='',CombHedgeFlag='',LimitPrice='',VolumeTotalOriginal='',TimeCondition='',GTDDate='',VolumeCondition='',MinVolume='',ContingentCondition='',StopPrice='',ForceCloseReason='',IsAutoSuspend='',BusinessUnit='',RequestID='',OrderLocalID='',ExchangeID='',ParticipantID='',ClientID='',ExchangeInstID='',TraderID='',InstallID='',OrderSubmitStatus='',NotifySequence='',TradingDay='',SettlementID='',OrderSysID='',OrderSource='',OrderStatus='',OrderType='',VolumeTraded='',VolumeTotal='',InsertDate='',InsertTime='',ActiveTime='',SuspendTime='',UpdateTime='',CancelTime='',ActiveTraderID='',ClearingPartID='',SequenceNo='',BranchID='',IPAddress='',MacAddress=''):
...
class InputOrderActionField(Base):
    ...
    def __init__(self,BrokerID='',InvestorID='',OrderActionRef='',OrderRef='',RequestID='',FrontID='',SessionID='',ExchangeID='',OrderSysID='',ActionFlag='',LimitPrice='',VolumeChange='',UserID='',InstrumentID='',InvestUnitID='',IPAddress='',MacAddress=''):
...
class OrderActionField(Base):
    ...
    def __init__(self,BrokerID='',InvestorID='',OrderActionRef='',OrderRef='',RequestID='',FrontID='',SessionID='',ExchangeID='',OrderSysID='',ActionFlag='',LimitPrice='',VolumeChange='',ActionDate='',ActionTime='',TraderID='',InstallID='',OrderLocalID='',ActionLocalID='',ParticipantID='',ClientID='',BusinessUnit='',OrderActionStatus='',UserID='',StatusMsg='',InstrumentID='',BranchID='',InvestUnitID='',IPAddress='',MacAddress=''):
...
class ExchangeOrderActionField(Base):
    ...
    def __init__(self,ExchangeID='',OrderSysID='',ActionFlag='',LimitPrice='',VolumeChange='',ActionDate='',ActionTime='',TraderID='',InstallID='',OrderLocalID='',ActionLocalID='',ParticipantID='',ClientID='',BusinessUnit='',OrderActionStatus='',UserID='',BranchID='',IPAddress='',MacAddress=''):
...
class ExchangeTradeField(Base):
    ...
    def __init__(self,ExchangeID='',TradeID='',Direction='',OrderSysID='',ParticipantID='',ClientID='',TradingRole='',ExchangeInstID='',OffsetFlag='',HedgeFlag='',Price='',Volume='',TradeDate='',TradeTime='',TradeType='',PriceSource='',TraderID='',OrderLocalID='',ClearingPartID='',BusinessUnit='',SequenceNo='',TradeSource=''):
...
class UserSessionField(Base):
    ...
    def __init__(self,FrontID='',SessionID='',BrokerID='',UserID='',LoginDate='',LoginTime='',IPAddress='',UserProductInfo='',InterfaceProductInfo='',ProtocolInfo='',MacAddress='',LoginRemark=''):
...
class QryHisOrderField(Base):
    ...
    def __init__(self,BrokerID='',InvestorID='',InstrumentID='',ExchangeID='',OrderSysID='',InsertTimeStart='',InsertTimeEnd='',TradingDay='',SettlementID=''):
...
class OptionInstrMarginAdjustField(Base):
    ...
    def __init__(self,InstrumentID='',InvestorRange='',BrokerID='',InvestorID='',SShortMarginRatioByMoney='',SShortMarginRatioByVolume='',HShortMarginRatioByMoney='',HShortMarginRatioByVolume='',AShortMarginRatioByMoney='',AShortMarginRatioByVolume='',IsRelative='',MShortMarginRatioByMoney='',MShortMarginRatioByVolume=''):
...
class OptionInstrCommRateField(Base):
    ...
    def __init__(self,InstrumentID='',InvestorRange='',BrokerID='',InvestorID='',OpenRatioByMoney='',OpenRatioByVolume='',CloseRatioByMoney='',CloseRatioByVolume='',CloseTodayRatioByMoney='',CloseTodayRatioByVolume='',StrikeRatioByMoney='',StrikeRatioByVolume=''):
...
class OptionInstrTradeCostField(Base):
    ...
    def __init__(self,BrokerID='',InvestorID='',InstrumentID='',HedgeFlag='',FixedMargin='',MiniMargin='',Royalty='',ExchFixedMargin='',ExchMiniMargin=''):
...
class InputExecOrderField(Base):
    ...
    def __init__(self,BrokerID='',InvestorID='',InstrumentID='',ExecOrderRef='',UserID='',Volume='',RequestID='',BusinessUnit='',OffsetFlag='',HedgeFlag='',ActionType='',PosiDirection='',ReservePositionFlag='',CloseFlag='',ExchangeID='',InvestUnitID='',AccountID='',CurrencyID='',ClientID='',IPAddress='',MacAddress=''):
...
class InputExecOrderActionField(Base):
    ...
    def __init__(self,BrokerID='',InvestorID='',ExecOrderActionRef='',ExecOrderRef='',RequestID='',FrontID='',SessionID='',ExchangeID='',ExecOrderSysID='',ActionFlag='',UserID='',InstrumentID='',InvestUnitID='',IPAddress='',MacAddress=''):
...
class ExecOrderField(Base):
    ...
    def __init__(self,BrokerID='',InvestorID='',InstrumentID='',ExecOrderRef='',UserID='',Volume='',RequestID='',BusinessUnit='',OffsetFlag='',HedgeFlag='',ActionType='',PosiDirection='',ReservePositionFlag='',CloseFlag='',ExecOrderLocalID='',ExchangeID='',ParticipantID='',ClientID='',ExchangeInstID='',TraderID='',InstallID='',OrderSubmitStatus='',NotifySequence='',TradingDay='',SettlementID='',ExecOrderSysID='',InsertDate='',InsertTime='',CancelTime='',ExecResult='',ClearingPartID='',SequenceNo='',FrontID='',SessionID='',UserProductInfo='',StatusMsg='',ActiveUserID='',BrokerExecOrderSeq='',BranchID='',InvestUnitID='',AccountID='',CurrencyID='',IPAddress='',MacAddress=''):
...
class ExchangeExecOrderField(Base):
    ...
    def __init__(self,Volume='',RequestID='',BusinessUnit='',OffsetFlag='',HedgeFlag='',ActionType='',PosiDirection='',ReservePositionFlag='',CloseFlag='',ExecOrderLocalID='',ExchangeID='',ParticipantID='',ClientID='',ExchangeInstID='',TraderID='',InstallID='',OrderSubmitStatus='',NotifySequence='',TradingDay='',SettlementID='',ExecOrderSysID='',InsertDate='',InsertTime='',CancelTime='',ExecResult='',ClearingPartID='',SequenceNo='',BranchID='',IPAddress='',MacAddress=''):
...
class ExchangeExecOrderActionField(Base):
    ...
    def __init__(self,ExchangeID='',ExecOrderSysID='',ActionFlag='',ActionDate='',ActionTime='',TraderID='',InstallID='',ExecOrderLocalID='',ActionLocalID='',ParticipantID='',ClientID='',BusinessUnit='',OrderActionStatus='',UserID='',ActionType='',BranchID='',IPAddress='',MacAddress=''):
...
class ErrExecOrderField(Base):
    ...
    def __init__(self,BrokerID='',InvestorID='',InstrumentID='',ExecOrderRef='',UserID='',Volume='',RequestID='',BusinessUnit='',OffsetFlag='',HedgeFlag='',ActionType='',PosiDirection='',ReservePositionFlag='',CloseFlag='',ExchangeID='',InvestUnitID='',AccountID='',CurrencyID='',ClientID='',IPAddress='',MacAddress='',ErrorID='',ErrorMsg=''):
...
class ErrExecOrderActionField(Base):
    ...
    def __init__(self,BrokerID='',InvestorID='',ExecOrderActionRef='',ExecOrderRef='',RequestID='',FrontID='',SessionID='',ExchangeID='',ExecOrderSysID='',ActionFlag='',UserID='',InstrumentID='',InvestUnitID='',IPAddress='',MacAddress='',ErrorID='',ErrorMsg=''):
...
class ForQuoteField(Base):
    ...
    def __init__(self,BrokerID='',InvestorID='',InstrumentID='',ForQuoteRef='',UserID='',ForQuoteLocalID='',ExchangeID='',ParticipantID='',ClientID='',ExchangeInstID='',TraderID='',InstallID='',InsertDate='',InsertTime='',ForQuoteStatus='',FrontID='',SessionID='',StatusMsg='',ActiveUserID='',BrokerForQutoSeq='',InvestUnitID='',IPAddress='',MacAddress=''):
...
class ExchangeForQuoteField(Base):
    ...
    def __init__(self,ForQuoteLocalID='',ExchangeID='',ParticipantID='',ClientID='',ExchangeInstID='',TraderID='',InstallID='',InsertDate='',InsertTime='',ForQuoteStatus='',IPAddress='',MacAddress=''):
...
class InputQuoteField(Base):
    ...
    def __init__(self,BrokerID='',InvestorID='',InstrumentID='',QuoteRef='',UserID='',AskPrice='',BidPrice='',AskVolume='',BidVolume='',RequestID='',BusinessUnit='',AskOffsetFlag='',BidOffsetFlag='',AskHedgeFlag='',BidHedgeFlag='',AskOrderRef='',BidOrderRef='',ForQuoteSysID='',ExchangeID='',InvestUnitID='',ClientID='',IPAddress='',MacAddress=''):
...
class InputQuoteActionField(Base):
    ...
    def __init__(self,BrokerID='',InvestorID='',QuoteActionRef='',QuoteRef='',RequestID='',FrontID='',SessionID='',ExchangeID='',QuoteSysID='',ActionFlag='',UserID='',InstrumentID='',InvestUnitID='',ClientID='',IPAddress='',MacAddress=''):
...
class QuoteField(Base):
    ...
    def __init__(self,BrokerID='',InvestorID='',InstrumentID='',QuoteRef='',UserID='',AskPrice='',BidPrice='',AskVolume='',BidVolume='',RequestID='',BusinessUnit='',AskOffsetFlag='',BidOffsetFlag='',AskHedgeFlag='',BidHedgeFlag='',QuoteLocalID='',ExchangeID='',ParticipantID='',ClientID='',ExchangeInstID='',TraderID='',InstallID='',NotifySequence='',OrderSubmitStatus='',TradingDay='',SettlementID='',QuoteSysID='',InsertDate='',InsertTime='',CancelTime='',QuoteStatus='',ClearingPartID='',SequenceNo='',AskOrderSysID='',BidOrderSysID='',FrontID='',SessionID='',UserProductInfo='',StatusMsg='',ActiveUserID='',BrokerQuoteSeq='',AskOrderRef='',BidOrderRef='',ForQuoteSysID='',BranchID='',InvestUnitID='',AccountID='',CurrencyID='',IPAddress='',MacAddress=''):
...
class QuoteActionField(Base):
    ...
    def __init__(self,BrokerID='',InvestorID='',QuoteActionRef='',QuoteRef='',RequestID='',FrontID='',SessionID='',ExchangeID='',QuoteSysID='',ActionFlag='',ActionDate='',ActionTime='',TraderID='',InstallID='',QuoteLocalID='',ActionLocalID='',ParticipantID='',ClientID='',BusinessUnit='',OrderActionStatus='',UserID='',StatusMsg='',InstrumentID='',BranchID='',InvestUnitID='',IPAddress='',MacAddress=''):
...
class ExchangeQuoteField(Base):
    ...
    def __init__(self,AskPrice='',BidPrice='',AskVolume='',BidVolume='',RequestID='',BusinessUnit='',AskOffsetFlag='',BidOffsetFlag='',AskHedgeFlag='',BidHedgeFlag='',QuoteLocalID='',ExchangeID='',ParticipantID='',ClientID='',ExchangeInstID='',TraderID='',InstallID='',NotifySequence='',OrderSubmitStatus='',TradingDay='',SettlementID='',QuoteSysID='',InsertDate='',InsertTime='',CancelTime='',QuoteStatus='',ClearingPartID='',SequenceNo='',AskOrderSysID='',BidOrderSysID='',ForQuoteSysID='',BranchID='',IPAddress='',MacAddress=''):
...
class ExchangeQuoteActionField(Base):
    ...
    def __init__(self,ExchangeID='',QuoteSysID='',ActionFlag='',ActionDate='',ActionTime='',TraderID='',InstallID='',QuoteLocalID='',ActionLocalID='',ParticipantID='',ClientID='',BusinessUnit='',OrderActionStatus='',UserID='',IPAddress='',MacAddress=''):
...
class InputBatchOrderActionField(Base):
    ...
    def __init__(self,BrokerID='',InvestorID='',OrderActionRef='',RequestID='',FrontID='',SessionID='',ExchangeID='',UserID='',InvestUnitID='',IPAddress='',MacAddress=''):
...
class BatchOrderActionField(Base):
    ...
    def __init__(self,BrokerID='',InvestorID='',OrderActionRef='',RequestID='',FrontID='',SessionID='',ExchangeID='',ActionDate='',ActionTime='',TraderID='',InstallID='',ActionLocalID='',ParticipantID='',ClientID='',BusinessUnit='',OrderActionStatus='',UserID='',StatusMsg='',InvestUnitID='',IPAddress='',MacAddress=''):
...
class ExchangeBatchOrderActionField(Base):
    ...
    def __init__(self,ExchangeID='',ActionDate='',ActionTime='',TraderID='',InstallID='',ActionLocalID='',ParticipantID='',ClientID='',BusinessUnit='',OrderActionStatus='',UserID='',IPAddress='',MacAddress=''):
...
class InputCombActionField(Base):
    ...
    def __init__(self,BrokerID='',InvestorID='',InstrumentID='',CombActionRef='',UserID='',Direction='',Volume='',CombDirection='',HedgeFlag='',ExchangeID='',IPAddress='',MacAddress=''):
...
class CombActionField(Base):
    ...
    def __init__(self,BrokerID='',InvestorID='',InstrumentID='',CombActionRef='',UserID='',Direction='',Volume='',CombDirection='',HedgeFlag='',ActionLocalID='',ExchangeID='',ParticipantID='',ClientID='',ExchangeInstID='',TraderID='',InstallID='',ActionStatus='',NotifySequence='',TradingDay='',SettlementID='',SequenceNo='',FrontID='',SessionID='',UserProductInfo='',StatusMsg='',IPAddress='',MacAddress=''):
...
class ExchangeCombActionField(Base):
    ...
    def __init__(self,Direction='',Volume='',CombDirection='',HedgeFlag='',ActionLocalID='',ExchangeID='',ParticipantID='',ClientID='',ExchangeInstID='',TraderID='',InstallID='',ActionStatus='',NotifySequence='',TradingDay='',SettlementID='',SequenceNo='',IPAddress='',MacAddress=''):
...
class InstrumentOrderCommRateField(Base):
    ...
    def __init__(self,InstrumentID='',InvestorRange='',BrokerID='',InvestorID='',HedgeFlag='',OrderCommByVolume='',OrderActionCommByVolume=''):
...
class MarketDataStaticField(Base):
    ...
    def __init__(self,OpenPrice='',HighestPrice='',LowestPrice='',ClosePrice='',UpperLimitPrice='',LowerLimitPrice='',SettlementPrice='',CurrDelta=''):
...
class InstrumentStatusField(Base):
    ...
    def __init__(self,ExchangeID='',ExchangeInstID='',SettlementGroupID='',InstrumentID='',InstrumentStatus='',TradingSegmentSN='',EnterTime='',EnterReason=''):
...
class BrokerWithdrawAlgorithmField(Base):
    ...
    def __init__(self,BrokerID='',WithdrawAlgorithm='',UsingRatio='',IncludeCloseProfit='',AllWithoutTrade='',AvailIncludeCloseProfit='',IsBrokerUserEvent='',CurrencyID='',FundMortgageRatio='',BalanceAlgorithm=''):
...
class LinkManField(Base):
    ...
    def __init__(self,BrokerID='',InvestorID='',PersonType='',IdentifiedCardType='',IdentifiedCardNo='',PersonName='',Telephone='',Address='',ZipCode='',Priority='',UOAZipCode='',PersonFullName=''):
...
class BrokerUserEventField(Base):
    ...
    def __init__(self,BrokerID='',UserID='',UserEventType='',EventSequenceNo='',EventDate='',EventTime='',UserEventInfo='',InvestorID='',InstrumentID=''):
...
class InvestorPositionCombineDetailField(Base):
    ...
    def __init__(self,TradingDay='',OpenDate='',ExchangeID='',SettlementID='',BrokerID='',InvestorID='',ComTradeID='',TradeID='',InstrumentID='',HedgeFlag='',Direction='',TotalAmt='',Margin='',ExchMargin='',MarginRateByMoney='',MarginRateByVolume='',LegID='',LegMultiple='',CombInstrumentID='',TradeGroupID=''):
...
class ParkedOrderActionField(Base):
    ...
    def __init__(self,BrokerID='',InvestorID='',OrderActionRef='',OrderRef='',RequestID='',FrontID='',SessionID='',ExchangeID='',OrderSysID='',ActionFlag='',LimitPrice='',VolumeChange='',UserID='',InstrumentID='',ParkedOrderActionID='',UserType='',Status='',ErrorID='',ErrorMsg='',InvestUnitID='',IPAddress='',MacAddress=''):
...
class ErrOrderField(Base):
    ...
    def __init__(self,BrokerID='',InvestorID='',InstrumentID='',OrderRef='',UserID='',OrderPriceType='',Direction='',CombOffsetFlag='',CombHedgeFlag='',LimitPrice='',VolumeTotalOriginal='',TimeCondition='',GTDDate='',VolumeCondition='',MinVolume='',ContingentCondition='',StopPrice='',ForceCloseReason='',IsAutoSuspend='',BusinessUnit='',RequestID='',UserForceClose='',ErrorID='',ErrorMsg='',IsSwapOrder='',ExchangeID='',InvestUnitID='',AccountID='',CurrencyID='',ClientID='',IPAddress='',MacAddress=''):
...
class ErrorConditionalOrderField(Base):
    ...
    def __init__(self,BrokerID='',InvestorID='',InstrumentID='',OrderRef='',UserID='',OrderPriceType='',Direction='',CombOffsetFlag='',CombHedgeFlag='',LimitPrice='',VolumeTotalOriginal='',TimeCondition='',GTDDate='',VolumeCondition='',MinVolume='',ContingentCondition='',StopPrice='',ForceCloseReason='',IsAutoSuspend='',BusinessUnit='',RequestID='',OrderLocalID='',ExchangeID='',ParticipantID='',ClientID='',ExchangeInstID='',TraderID='',InstallID='',OrderSubmitStatus='',NotifySequence='',TradingDay='',SettlementID='',OrderSysID='',OrderSource='',OrderStatus='',OrderType='',VolumeTraded='',VolumeTotal='',InsertDate='',InsertTime='',ActiveTime='',SuspendTime='',UpdateTime='',CancelTime='',ActiveTraderID='',ClearingPartID='',SequenceNo='',FrontID='',SessionID='',UserProductInfo='',StatusMsg='',UserForceClose='',ActiveUserID='',BrokerOrderSeq='',RelativeOrderSysID='',ZCETotalTradedVolume='',ErrorID='',ErrorMsg='',IsSwapOrder='',BranchID='',InvestUnitID='',AccountID='',CurrencyID='',IPAddress='',MacAddress=''):
...
class ErrOrderActionField(Base):
    ...
    def __init__(self,BrokerID='',InvestorID='',OrderActionRef='',OrderRef='',RequestID='',FrontID='',SessionID='',ExchangeID='',OrderSysID='',ActionFlag='',LimitPrice='',VolumeChange='',ActionDate='',ActionTime='',TraderID='',InstallID='',OrderLocalID='',ActionLocalID='',ParticipantID='',ClientID='',BusinessUnit='',OrderActionStatus='',UserID='',StatusMsg='',InstrumentID='',BranchID='',InvestUnitID='',IPAddress='',MacAddress='',ErrorID='',ErrorMsg=''):
...
class BrokerTradingParamsField(Base):
    ...
    def __init__(self,BrokerID='',InvestorID='',MarginPriceType='',Algorithm='',AvailIncludeCloseProfit='',CurrencyID='',OptionRoyaltyPriceType=''):
...
class BrokerDepositField(Base):
    ...
    def __init__(self,TradingDay='',BrokerID='',ParticipantID='',ExchangeID='',PreBalance='',CurrMargin='',CloseProfit='',Balance='',Deposit='',Withdraw='',Available='',Reserve='',FrozenMargin=''):
...
class BulletinField(Base):
    ...
    def __init__(self,ExchangeID='',TradingDay='',BulletinID='',SequenceNo='',NewsType='',NewsUrgency='',SendTime='',Abstract='',ComeFrom='',Content='',URLLink='',MarketID=''):
...
class ReqOpenAccountField(Base):
    ...
    def __init__(self,TradeCode='',BankID='',BankBranchID='',BrokerID='',BrokerBranchID='',TradeDate='',TradeTime='',BankSerial='',TradingDay='',PlateSerial='',LastFragment='',SessionID='',CustomerName='',IdCardType='',IdentifiedCardNo='',Gender='',CountryCode='',CustType='',Address='',ZipCode='',Telephone='',MobilePhone='',Fax='',EMail='',MoneyAccountStatus='',BankAccount='',BankPassWord='',AccountID='',Password='',InstallID='',VerifyCertNoFlag='',CurrencyID='',CashExchangeCode='',Digest='',BankAccType='',DeviceID='',BankSecuAccType='',BrokerIDByBank='',BankSecuAcc='',BankPwdFlag='',SecuPwdFlag='',OperNo='',TID='',UserID='',LongCustomerName=''):
...
class ReqChangeAccountField(Base):
    ...
    def __init__(self,TradeCode='',BankID='',BankBranchID='',BrokerID='',BrokerBranchID='',TradeDate='',TradeTime='',BankSerial='',TradingDay='',PlateSerial='',LastFragment='',SessionID='',CustomerName='',IdCardType='',IdentifiedCardNo='',Gender='',CountryCode='',CustType='',Address='',ZipCode='',Telephone='',MobilePhone='',Fax='',EMail='',MoneyAccountStatus='',BankAccount='',BankPassWord='',NewBankAccount='',NewBankPassWord='',AccountID='',Password='',BankAccType='',InstallID='',VerifyCertNoFlag='',CurrencyID='',BrokerIDByBank='',BankPwdFlag='',SecuPwdFlag='',TID='',Digest='',LongCustomerName=''):
...
class ReqTransferField(Base):
    ...
    def __init__(self,TradeCode='',BankID='',BankBranchID='',BrokerID='',BrokerBranchID='',TradeDate='',TradeTime='',BankSerial='',TradingDay='',PlateSerial='',LastFragment='',SessionID='',CustomerName='',IdCardType='',IdentifiedCardNo='',CustType='',BankAccount='',BankPassWord='',AccountID='',Password='',InstallID='',FutureSerial='',UserID='',VerifyCertNoFlag='',CurrencyID='',TradeAmount='',FutureFetchAmount='',FeePayFlag='',CustFee='',BrokerFee='',Message='',Digest='',BankAccType='',DeviceID='',BankSecuAccType='',BrokerIDByBank='',BankSecuAcc='',BankPwdFlag='',SecuPwdFlag='',OperNo='',RequestID='',TID='',TransferStatus='',LongCustomerName=''):
...
class RspTransferField(Base):
    ...
    def __init__(self,TradeCode='',BankID='',BankBranchID='',BrokerID='',BrokerBranchID='',TradeDate='',TradeTime='',BankSerial='',TradingDay='',PlateSerial='',LastFragment='',SessionID='',CustomerName='',IdCardType='',IdentifiedCardNo='',CustType='',BankAccount='',BankPassWord='',AccountID='',Password='',InstallID='',FutureSerial='',UserID='',VerifyCertNoFlag='',CurrencyID='',TradeAmount='',FutureFetchAmount='',FeePayFlag='',CustFee='',BrokerFee='',Message='',Digest='',BankAccType='',DeviceID='',BankSecuAccType='',BrokerIDByBank='',BankSecuAcc='',BankPwdFlag='',SecuPwdFlag='',OperNo='',RequestID='',TID='',TransferStatus='',ErrorID='',ErrorMsg='',LongCustomerName=''):
...
class ReqQueryAccountField(Base):
    ...
    def __init__(self,TradeCode='',BankID='',BankBranchID='',BrokerID='',BrokerBranchID='',TradeDate='',TradeTime='',BankSerial='',TradingDay='',PlateSerial='',LastFragment='',SessionID='',CustomerName='',IdCardType='',IdentifiedCardNo='',CustType='',BankAccount='',BankPassWord='',AccountID='',Password='',FutureSerial='',InstallID='',UserID='',VerifyCertNoFlag='',CurrencyID='',Digest='',BankAccType='',DeviceID='',BankSecuAccType='',BrokerIDByBank='',BankSecuAcc='',BankPwdFlag='',SecuPwdFlag='',OperNo='',RequestID='',TID='',LongCustomerName=''):
...
class RspQueryAccountField(Base):
    ...
    def __init__(self,TradeCode='',BankID='',BankBranchID='',BrokerID='',BrokerBranchID='',TradeDate='',TradeTime='',BankSerial='',TradingDay='',PlateSerial='',LastFragment='',SessionID='',CustomerName='',IdCardType='',IdentifiedCardNo='',CustType='',BankAccount='',BankPassWord='',AccountID='',Password='',FutureSerial='',InstallID='',UserID='',VerifyCertNoFlag='',CurrencyID='',Digest='',BankAccType='',DeviceID='',BankSecuAccType='',BrokerIDByBank='',BankSecuAcc='',BankPwdFlag='',SecuPwdFlag='',OperNo='',RequestID='',TID='',BankUseAmount='',BankFetchAmount='',LongCustomerName=''):
...
class FutureSignIOField(Base):
    ...
    def __init__(self,TradeCode='',BankID='',BankBranchID='',BrokerID='',BrokerBranchID='',TradeDate='',TradeTime='',BankSerial='',TradingDay='',PlateSerial='',LastFragment='',SessionID='',InstallID='',UserID='',Digest='',CurrencyID='',DeviceID='',BrokerIDByBank='',OperNo='',RequestID='',TID=''):
...
class RspFutureSignInField(Base):
    ...
    def __init__(self,TradeCode='',BankID='',BankBranchID='',BrokerID='',BrokerBranchID='',TradeDate='',TradeTime='',BankSerial='',TradingDay='',PlateSerial='',LastFragment='',SessionID='',InstallID='',UserID='',Digest='',CurrencyID='',DeviceID='',BrokerIDByBank='',OperNo='',RequestID='',TID='',ErrorID='',ErrorMsg='',PinKey='',MacKey=''):
...
class RspFutureSignOutField(Base):
    ...
    def __init__(self,TradeCode='',BankID='',BankBranchID='',BrokerID='',BrokerBranchID='',TradeDate='',TradeTime='',BankSerial='',TradingDay='',PlateSerial='',LastFragment='',SessionID='',InstallID='',UserID='',Digest='',CurrencyID='',DeviceID='',BrokerIDByBank='',OperNo='',RequestID='',TID='',ErrorID='',ErrorMsg=''):
...
class ReqQueryTradeResultBySerialField(Base):
    ...
    def __init__(self,TradeCode='',BankID='',BankBranchID='',BrokerID='',BrokerBranchID='',TradeDate='',TradeTime='',BankSerial='',TradingDay='',PlateSerial='',LastFragment='',SessionID='',Reference='',RefrenceIssureType='',RefrenceIssure='',CustomerName='',IdCardType='',IdentifiedCardNo='',CustType='',BankAccount='',BankPassWord='',AccountID='',Password='',CurrencyID='',TradeAmount='',Digest='',LongCustomerName=''):
...
class RspQueryTradeResultBySerialField(Base):
    ...
    def __init__(self,TradeCode='',BankID='',BankBranchID='',BrokerID='',BrokerBranchID='',TradeDate='',TradeTime='',BankSerial='',TradingDay='',PlateSerial='',LastFragment='',SessionID='',ErrorID='',ErrorMsg='',Reference='',RefrenceIssureType='',RefrenceIssure='',OriginReturnCode='',OriginDescrInfoForReturnCode='',BankAccount='',BankPassWord='',AccountID='',Password='',CurrencyID='',TradeAmount='',Digest=''):
...
class ReqDayEndFileReadyField(Base):
    ...
    def __init__(self,TradeCode='',BankID='',BankBranchID='',BrokerID='',BrokerBranchID='',TradeDate='',TradeTime='',BankSerial='',TradingDay='',PlateSerial='',LastFragment='',SessionID='',FileBusinessCode='',Digest=''):
...
class VerifyFuturePasswordField(Base):
    ...
    def __init__(self,TradeCode='',BankID='',BankBranchID='',BrokerID='',BrokerBranchID='',TradeDate='',TradeTime='',BankSerial='',TradingDay='',PlateSerial='',LastFragment='',SessionID='',AccountID='',Password='',BankAccount='',BankPassWord='',InstallID='',TID='',CurrencyID=''):
...
class ReqSyncKeyField(Base):
    ...
    def __init__(self,TradeCode='',BankID='',BankBranchID='',BrokerID='',BrokerBranchID='',TradeDate='',TradeTime='',BankSerial='',TradingDay='',PlateSerial='',LastFragment='',SessionID='',InstallID='',UserID='',Message='',DeviceID='',BrokerIDByBank='',OperNo='',RequestID='',TID=''):
...
class RspSyncKeyField(Base):
    ...
    def __init__(self,TradeCode='',BankID='',BankBranchID='',BrokerID='',BrokerBranchID='',TradeDate='',TradeTime='',BankSerial='',TradingDay='',PlateSerial='',LastFragment='',SessionID='',InstallID='',UserID='',Message='',DeviceID='',BrokerIDByBank='',OperNo='',RequestID='',TID='',ErrorID='',ErrorMsg=''):
...
class TransferSerialField(Base):
    ...
    def __init__(self,PlateSerial='',TradeDate='',TradingDay='',TradeTime='',TradeCode='',SessionID='',BankID='',BankBranchID='',BankAccType='',BankAccount='',BankSerial='',BrokerID='',BrokerBranchID='',FutureAccType='',AccountID='',InvestorID='',FutureSerial='',IdCardType='',IdentifiedCardNo='',CurrencyID='',TradeAmount='',CustFee='',BrokerFee='',AvailabilityFlag='',OperatorCode='',BankNewAccount='',ErrorID='',ErrorMsg=''):
...
class AccountregisterField(Base):
    ...
    def __init__(self,TradeDay='',BankID='',BankBranchID='',BankAccount='',BrokerID='',BrokerBranchID='',AccountID='',IdCardType='',IdentifiedCardNo='',CustomerName='',CurrencyID='',OpenOrDestroy='',RegDate='',OutDate='',TID='',CustType='',BankAccType='',LongCustomerName=''):
...
class OpenAccountField(Base):
    ...
    def __init__(self,TradeCode='',BankID='',BankBranchID='',BrokerID='',BrokerBranchID='',TradeDate='',TradeTime='',BankSerial='',TradingDay='',PlateSerial='',LastFragment='',SessionID='',CustomerName='',IdCardType='',IdentifiedCardNo='',Gender='',CountryCode='',CustType='',Address='',ZipCode='',Telephone='',MobilePhone='',Fax='',EMail='',MoneyAccountStatus='',BankAccount='',BankPassWord='',AccountID='',Password='',InstallID='',VerifyCertNoFlag='',CurrencyID='',CashExchangeCode='',Digest='',BankAccType='',DeviceID='',BankSecuAccType='',BrokerIDByBank='',BankSecuAcc='',BankPwdFlag='',SecuPwdFlag='',OperNo='',TID='',UserID='',ErrorID='',ErrorMsg='',LongCustomerName=''):
...
class ChangeAccountField(Base):
    ...
    def __init__(self,TradeCode='',BankID='',BankBranchID='',BrokerID='',BrokerBranchID='',TradeDate='',TradeTime='',BankSerial='',TradingDay='',PlateSerial='',LastFragment='',SessionID='',CustomerName='',IdCardType='',IdentifiedCardNo='',Gender='',CountryCode='',CustType='',Address='',ZipCode='',Telephone='',MobilePhone='',Fax='',EMail='',MoneyAccountStatus='',BankAccount='',BankPassWord='',NewBankAccount='',NewBankPassWord='',AccountID='',Password='',BankAccType='',InstallID='',VerifyCertNoFlag='',CurrencyID='',BrokerIDByBank='',BankPwdFlag='',SecuPwdFlag='',TID='',Digest='',ErrorID='',ErrorMsg='',LongCustomerName=''):
...
class ReserveOpenAccountConfirmField(Base):
    ...
    def __init__(self,TradeCode='',BankID='',BankBranchID='',BrokerID='',BrokerBranchID='',TradeDate='',TradeTime='',BankSerial='',TradingDay='',PlateSerial='',LastFragment='',SessionID='',CustomerName='',IdCardType='',IdentifiedCardNo='',Gender='',CountryCode='',CustType='',Address='',ZipCode='',Telephone='',MobilePhone='',Fax='',EMail='',MoneyAccountStatus='',BankAccount='',BankPassWord='',InstallID='',VerifyCertNoFlag='',CurrencyID='',Digest='',BankAccType='',BrokerIDByBank='',TID='',AccountID='',Password='',BankReserveOpenSeq='',BookDate='',BookPsw='',ErrorID='',ErrorMsg=''):
...
class ReserveOpenAccountField(Base):
    ...
    def __init__(self,TradeCode='',BankID='',BankBranchID='',BrokerID='',BrokerBranchID='',TradeDate='',TradeTime='',BankSerial='',TradingDay='',PlateSerial='',LastFragment='',SessionID='',CustomerName='',IdCardType='',IdentifiedCardNo='',Gender='',CountryCode='',CustType='',Address='',ZipCode='',Telephone='',MobilePhone='',Fax='',EMail='',MoneyAccountStatus='',BankAccount='',BankPassWord='',InstallID='',VerifyCertNoFlag='',CurrencyID='',Digest='',BankAccType='',BrokerIDByBank='',TID='',ReserveOpenAccStas='',ErrorID='',ErrorMsg=''):
